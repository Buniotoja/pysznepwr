	...
	<input type='number' name='ilosc1' class="wpisywanie2"/><br/>
		<?php 
			...
			$polaczenie = @new mysqli($host, $db_user, $db_password, $db_name);
				...
				$pizza=@$polaczenie->query("SELECT nazwa, skladniki, cena FROM menu3 WHERE id=1");
	...
	<input type='number' name='ilosc2' class="wpisywanie2"/><br/>
		<?php 
			...
			$polaczenie = @new mysqli($host, $db_user, $db_password, $db_name);
				...
				$pizza=@$polaczenie->query("SELECT nazwa, skladniki, cena FROM menu3 WHERE id=2");
				$pizzaAs=$pizza->fetch_assoc(); 
	...
	<input type='number' name='ilosc3' class="wpisywanie2"/><br/>
		<?php 
			...
			$polaczenie = @new mysqli($host, $db_user, $db_password, $db_name);
				...
				$pizza=@$polaczenie->query("SELECT nazwa, skladniki, cena FROM menu3 WHERE id=3");
				$pizzaAs=$pizza->fetch_assoc(); 
	...
	<input type='number' name='ilosc4' class="wpisywanie2"/><br/>
		<?php 
			...
			$polaczenie = @new mysqli($host, $db_user, $db_password, $db_name);
				...
				$pizza=@$polaczenie->query("SELECT nazwa, skladniki, cena FROM menu3 WHERE id=4");
				$pizzaAs=$pizza->fetch_assoc(); 
